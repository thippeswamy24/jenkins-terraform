pipeline {
    ...
    stages {
        ...
        stage('git clone') {
            steps {
                sh 'sudo rm -rf&sudo rm -rf .git /home/ec2-user/newfolder/*'
                sh 'sudo rm -rf *;sudo git clone https://github.com/thippeswamy24/jenkins-terraform.git /home/ec2-user/newfolder'
            }
        }
